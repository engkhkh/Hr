...
{
    public class MessagesDetailsController : Controller
    {
        private readonly hrContext _context;

        public MessagesDetailsController(hrContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.MessagesDetailss.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var offerDetails = await _context.MessagesDetailss
        ...
        public  IActionResult Create(int? id, string  from)
        {
            ...
            var OfferDetailssss = _context.MessagesDetailss
        ...
        public IActionResult Create(MessagesDetail OfferDetails)
        {
           ...
           .SingleOrDefault();
                ...
                if (OfferDetailssss.OfferedRequestTo == HttpContext.Session.GetString("empid") && OfferDetailssss.OfferedRequestTo3 == "0")
                {
                    ...
                    Messagescomment offerComments = new Messagescomment
                    {
                    ...
                    _context.SaveChanges();
                    var OfferRequestTypeIdsMasterRequestTypeIdserial2 = _context.MessagesRequestTypeIds.Where(b => b.CourcesIdoffered == OfferDetails.CourcesIdoffered && b.Offercoursefrom == OfferDetailssss.OfferedRequestFrom).FirstOrDefault();
                    ...
                    _context.SaveChanges();
                    return RedirectToAction("IndexOffered4", "Cemps", new { area = "" });
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create2( MessagesDetail OfferDetails)
        {
