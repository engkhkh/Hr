...
namespace Hr.Controllers
{
    public class OfferDetailsController : Controller
    {
        ...
        public OfferDetailsController(hrContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.OfferedDetails.ToListAsync());
        }
        ...
        public  IActionResult Create(int? id, string  from)
        {
            ...
            var OfferDetailssss = _context.OfferedDetails
        ...
        public IActionResult Create([Bind("OfferedDetailsSerial,COURCES_IDOffered,OfferedRequestFrom,OfferedRequestTo,OfferedRequestTo2,OfferedRequestTo3,OfferedRequestTo4,OfferedRequestTo5,OfferedRequestTypeSatus,OfferedRequestNotes,Offeredoption")] OfferedDetails OfferDetails)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create2([Bind("OfferedDetailsSerial,COURCES_IDOffered,OfferedRequestFrom,OfferedRequestTo,OfferedRequestTo2,OfferedRequestTo3,OfferedRequestTo4,OfferedRequestTo5,OfferedRequestTypeSatus,OfferedRequestNotes,Offeredoption")] OfferedDetails OfferDetails)
        {
