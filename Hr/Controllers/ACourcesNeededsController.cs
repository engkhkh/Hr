...
{
    public class ACourcesNeededsController : Controller
    {
        private readonly hrContext _context;

        public ACourcesNeededsController(hrContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.ACourcesNeeded.ToListAsync());
        }
        [HttpGet]
