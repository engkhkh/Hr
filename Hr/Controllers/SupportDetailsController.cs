...
namespace Hr.Controllers
{
    public class SupportDetailsController : Controller
    {
        ...
        public  IActionResult Create(int? id, string  from)
        {
            ...
            var OfferDetailssss = _context.SupportDetails
        ...
        public async Task<IActionResult> Create( SupportDetail OfferDetails)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create2( SupportDetail OfferDetails)
        {
