...
{
    public class AJobsNamesController : Controller
    {
        private readonly hrContext _context;

        public AJobsNamesController(hrContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.AJobsNames.ToListAsync());
        }
        [Authorize(Roles = "Admin,HR-Admin")]
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var aCourcesName = await _context.AJobsNames
        ...
        [Authorize(Roles = "Admin,HR-Admin")]
        public async Task<IActionResult> Create([Bind("CourcesId,CourcesName")] AJobsNames aCourcesName)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var aCourcesName = await _context.AJobsNames.FindAsync(id);
            if (aCourcesName == null)
            {
                return NotFound();
            }
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Admin,HR-Admin")]
        public async Task<IActionResult> Edit(int id, [Bind("CourcesId,CourcesName")] AJobsNames aCourcesName)
        {
        ...
        {
            var aCourcesName = await _context.AJobsNames.FindAsync(id);
            _context.AJobsNames.Remove(aCourcesName);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.AJobsNames.Any(e => e.CourcesId == id);
        }
    }
}
