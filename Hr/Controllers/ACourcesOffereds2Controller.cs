...
{
    public class ACourcesOffereds2Controller : Controller
    {
        private readonly hrContext _context;
        private readonly IHostingEnvironment _hosting;

        public ACourcesOffereds2Controller(hrContext context, IHostingEnvironment hosting)
        {
            _context = context;
            _hosting = hosting;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.ACourcesOffered2.ToListAsync());
        }
        [HttpGet]
        ...
        public ActionResult search1()
        {
            ...
            List<Cemp> Cemps = _context.Cemps.ToList();
            //List<ACourcesIdManagement> ACourcesIdManagements = _context.ACourcesIdManagement.ToList();
            List<ACourcesOffered2> ACourcesOffereds2 = _context.ACourcesOffered2.ToList();
            List<ACourcesDeptin> ACourcesDeptins = _context.ACourcesDeptins.ToList();
            List<MasterRequestTypeId> MasterRequestTypeIds = _context.MasterRequestTypeIds.ToList();
            List<MasterDetails> MasterDetailss = _context.MasterDetailss.ToList();
            List<ACourcesDeptout> ACourcesDeptouts = _context.ACourcesDeptouts.ToList();
            ...
            var Records = from e in ACourcesOffereds2
                          join d in ACoursesLocations on e.CourcesIdLocation equals d.id into table1
                          from d in table1.ToList()
                          join i in Cemps on e.Cempid equals i.Cempid into table2
                           from i in table2.ToList()
        ...
        public async Task<IActionResult> Create([Bind("CourcesOfferedId,CourcesId,CourcesIdDeptout,CourcesIdLocation,CourcesIdManagement,CourcesIdperiodbydays,CourcesIdTime,CourcesStartDate,CourcesStartDateh,CourcesIdTraining,Cempid,available,timefrom,timeto,COURCES_ID_IMAGE,Filehr")] ACourcesOffered2 aCourcesOffered2)
        {
            ...
            if (aCourcesOffered2.Filehr != null)
            {
                ...
                aCourcesOffered2.Filehr.CopyTo(new FileStream(fullPath2, FileMode.Create));
                x = file2;
            }
            else
            {
            ...
            if (ModelState.IsValid)
            {
                ...
                aCourcesOffered2.Cempid = HttpContext.Session.GetString("username");
                aCourcesOffered2.Option = 0;
                aCourcesOffered2.COURCES_ID_IMAGE = x == x ? x : y;
                _context.Add(aCourcesOffered2);
                await _context.SaveChangesAsync();
                ...
                if (depwithmangforemp != null)
                {
                    ...
                    OfferedDetails2 OfferedDetailss = new OfferedDetails2
                    {
                        COURCES_IDOffered = aCourcesOffered2.CourcesOfferedId/*_context.ACourcesOffered.Max(u => u.CourcesOfferedId) + 1*/,
                        OfferedRequestFrom = HttpContext.Session.GetString("empid"),
                        OfferedRequestTo = depwithmangforemp.MANAGERID,// status in offerrequestto3
                        OfferedRequestTo2 = depwithmangforemp.PARENTMANAGERID,// status in offerrequestto4
                        OfferedRequestTo3 = "0",
                ...
                OfferedRequestTypeId2 OfferedRequestTypeIds = new OfferedRequestTypeId2
                {
                    COURCES_IDOffered = aCourcesOffered2.CourcesOfferedId,
                    Offercoursefrom = HttpContext.Session.GetString("empid"),
                    OfferedRequestType = 0
