...
namespace Hr.Controllers
{
    public class ACourcesDeptoutsController : Controller
    {
        ...
        [Authorize(Roles = "Admin,HR-Admin")]
        public async Task<IActionResult> Create([Bind("CourcesIdDeptout,CourcesNameDeptout,Ttype")] ACourcesDeptout aCourcesDeptout)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Admin,HR-Admin")]
        public async Task<IActionResult> Edit(int id, [Bind("CourcesIdDeptout,CourcesNameDeptout,Ttype")] ACourcesDeptout aCourcesDeptout)
        {
