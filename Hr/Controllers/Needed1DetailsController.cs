...
namespace Hr.Controllers
{
    public class Needed1DetailsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.Needed1Details.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var offerDetails = await _context.Needed1Details
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create2([Bind("OfferedDetailsSerial,COURCES_IDOffered,OfferedRequestFrom,OfferedRequestTo,OfferedRequestTo2,OfferedRequestTo3,OfferedRequestTo4,OfferedRequestTo5,OfferedRequestTypeSatus,OfferedRequestNotes,Offeredoption")] Needed1Details OfferDetails)
        {
