...
{
    public class TMDetailsController : Controller
    {
        private readonly hrContext _context;
        private readonly IMailService mailService;
        NLog.Logger loggerx = LogManager.GetCurrentClassLogger();

        public TMDetailsController(hrContext context, IMailService mailService)
        {
            _context = context;
        ...
        public  IActionResult Create(int? id, string  from)
        {
            ...
            var OfferDetailssss = _context.TMDetailss2
        ...
        public async Task<IActionResult> Create( TMDetail2 OfferDetails)
        {
           ...
           .SingleOrDefault();
                ...
                if (OfferDetailssss.OfferedRequestTo == "4419011")
                {
                    ...
                    TMcomment2 offerComments = new TMcomment2
                    {
                    ...
                    var OfferRequestTypeIdsMasterRequestTypeIdserial2 = _context.TMRequestTypeIds2.Where(b => b.CourcesIdoffered == OfferDetails.CourcesIdoffered && b.Offercoursefrom == OfferDetailssss.OfferedRequestFrom).FirstOrDefault();
                    ...
                    request3.header = "خدمة مهام الإدارة ";
                    request3.Details = "تم اعتماد طلب خدمة مهام الإدارة ,طلب رقم :" + OfferRequestTypeIdsMasterRequestTypeIdserial2.CourcesIdoffered + " بواسطة   : " + empapproval2.CEMPNAME;
                    ...
                    {
                        loggerx.Error("  لم يتم ارسال الايميل للموظف ب خدمة مهام الإدارة   " + emprequestor.Cempid + "اعتماد خدمة مهام الإدارة " + ex.Message);
                    }



                    return RedirectToAction("IndexOffered3", "ViewModelTasks", new { area = "" });
                ...
                else
                {
                    ...
                    else if (OfferDetailssss.OfferedRequestTo2 == HttpContext.Session.GetString("empid") && OfferDetailssss.OfferedRequestTo4 == "0")
                    {
                        ...
                        request3.UserName = emprequestor.CEMPNAME;
                        request3.header = "خدمة مهام الإدارة ";
                        request3.Details = "تم اعتماد خدمة مهام الإدارة ,طلب رقم :" + OfferRequestTypeIdsMasterRequestTypeIdserial2.CourcesIdoffered + " بواسطة   : " + empapproval2.CEMPNAME;
                        request3.ToEmail = emprequestor.mail;
                        try
                        {
                            //await mailService.SendEmailAsync(m);
                        ...
                        {
                            loggerx.Error("  لم يتم ارسال الايميل للموظف ب خدمة مهام الإدارة   " + emprequestor.Cempid + "خدمة مهام الإدارة " + ex.Message);
                        }
                        return RedirectToAction("IndexOffered3", "ViewModelTasks", new { area = "" });
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create2( TMDetail2 OfferDetails)
        {
               ...
               .SingleOrDefault();
                    ...
                    request3.UserName = emprequestor.CEMPNAME;
                    request3.header = "خدمة مهام الإدارة ";
                    request3.Details = "تم رفض اعتماد خدمة مهام الإدارة ,طلب رقم :" + OfferRequestTypeIdsMasterRequestTypeIdserial2.CourcesIdoffered + " بواسطة  : " + empapproval2.CEMPNAME;
                    request3.ToEmail = emprequestor.mail;
                    try
                    {
                        //await mailService.SendEmailAsync(m);
                    ...
                    {
                        loggerx.Error("  لم يتم ارسال الايميل للموظف ب خدمة مهام الإدارة   " + emprequestor.Cempid + "رفض  خدمة مهام الإدارة " + ex.Message);
                    }
