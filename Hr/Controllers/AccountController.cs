       ...
       //"User Id= hr;Password=hr";
        ...
        public IActionResult Login(string username, string password)
        {
            ...
            if (username != null && password != null && d==true /*username.Equals(objuser.Cempid) && password.Equals(objuser.CEMPPASSWRD)*/)
            {
                ...
                OracleDataAdapter da = new OracleDataAdapter("select * from MADCAP.AV_GETPASS", Con);
                da.Fill(tab);
                ...
                OracleDataAdapter da0 = new OracleDataAdapter("select * from MADCAP.AV_GETPASS", Con);
                da0.Fill(tab0);
                ...
                OracleDataAdapter da1 = new OracleDataAdapter("select * from MADCAP.A_VGET_EMP_DATA", Con);
                da1.Fill(tab1);
                ...
                var claims = new List<Claim>
            {
                ...
                try
                {
                    ...
                    logind.comment = "Sucessful Login to HR Gate By //"+username + "//" +password;
                    ...
                    objuser.CROLEID = objuser.CROLEID==2?Convert.ToInt32(role):objuser.CROLEID == 3 ? Convert.ToInt32(role) : objuser.CROLEID == 5 ? 5 : objuser.CROLEID == 1 ? 1 : 3;
