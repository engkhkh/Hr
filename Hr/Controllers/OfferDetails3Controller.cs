...
{
    public class OfferDetails3Controller : Controller
    {
        private readonly hrContext _context;

        public OfferDetails3Controller(hrContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create2([Bind("OfferedDetailsSerial,COURCES_IDOffered,OfferedRequestFrom,OfferedRequestTo,OfferedRequestTo2,OfferedRequestTo3,OfferedRequestTo4,OfferedRequestTo5,OfferedRequestTypeSatus,OfferedRequestNotes,Offeredoption")] OfferedDetails3 OfferDetails)
        {
