...
{
    public class OfferDetails2Controller : Controller
    {
        private readonly hrContext _context;

        public OfferDetails2Controller(hrContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.OfferedDetails2.ToListAsync());
        }
        ...
        public  IActionResult Create(int? id, string  from)
        {
            ...
            var OfferDetailssss = _context.OfferedDetails2
        ...
        public IActionResult Create([Bind("OfferedDetailsSerial,COURCES_IDOffered,OfferedRequestFrom,OfferedRequestTo,OfferedRequestTo2,OfferedRequestTo3,OfferedRequestTo4,OfferedRequestTo5,OfferedRequestTypeSatus,OfferedRequestNotes,Offeredoption")] OfferedDetails2 OfferDetails)
        {
           ...
           .SingleOrDefault();
                ...
                if (OfferDetailssss.OfferedRequestTo == HttpContext.Session.GetString("empid") && OfferDetailssss.OfferedRequestTo3 == "0")
                {
                    ...
                    OfferComments2 offerComments = new OfferComments2
                    {
                    ...
                    _context.SaveChangesAsync();
                    return RedirectToAction("IndexOffered2", "ViewModelMasterwithother", new { area = "" });
                ...
                else if (OfferDetailssss.Offeredoption == HttpContext.Session.GetString("empid") && OfferDetailssss.OfferedRequestTo5 == "0")
                {
                    ...
                    var OfferRequestTypeIdsMasterRequestTypeIdserial2 = _context.OfferedRequestTypeId2.Where(b => b.COURCES_IDOffered == OfferDetails.COURCES_IDOffered && b.Offercoursefrom == OfferDetailssss.OfferedRequestFrom).FirstOrDefault();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create2([Bind("OfferedDetailsSerial,COURCES_IDOffered,OfferedRequestFrom,OfferedRequestTo,OfferedRequestTo2,OfferedRequestTo3,OfferedRequestTo4,OfferedRequestTo5,OfferedRequestTypeSatus,OfferedRequestNotes,Offeredoption")] OfferedDetails2 OfferDetails)
        {
