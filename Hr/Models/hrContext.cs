...
namespace Hr.Models
{
    public partial class hrContext : DbContext
    {
        ...
        public virtual DbSet<MasterDetailsApprovals> MasterDetailsApprovals { get; set; }
        ...
        public virtual DbSet<commiteza> commiteza { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //
            modelBuilder.Entity<MasterDetailsApprovals>(entity =>
            {
                entity.ToTable("MasterDetailsApprovals");
                entity.HasKey(e => e.id);

                entity.Property(e => e.id).HasColumnName("id");
                entity.Property(e => e.MasterRequestTo)
                    .HasColumnName("MasterRequestTo");
                entity.Property(e => e.MasterRequestTo2)
                  .HasColumnName("MasterRequestTo2");

                entity.Property(e => e.MasterRequestTo3)
                  .HasColumnName("MasterRequestTo3");
                entity.Property(e => e.MasterRequestTo4)
                  .HasColumnName("MasterRequestTo4");

                entity.Property(e => e.MasterRequestTo5)
               .HasColumnName("MasterRequestTo5");
            ...
            //
            modelBuilder.Entity<commiteza>(entity =>
            {
                entity.ToTable("commiteza");
                entity.HasKey(e => e.id);
