...
namespace Hr.Models
{
    [Keyless]
    [NotMapped]
    public class UpDbIHostService : IHostedService
    {
        private Timer timer;
        ...
        string grade = "";
        string mobileno = "";
        public UpDbIHostService(IServiceScopeFactory serviceScopeFactory, IConfiguration _configuration)
        {
        ...
        {
            timer = new Timer(checkAndRegenerateRights, null, 10000, 180000);
        ...
        private void checkAndRegenerateRights(object state)
        {
            ...
            using (var scope = _serviceScopeFactory.CreateScope())
            {
                ...
                Cemp cemp;
                foreach (var cemp0 in cemps.ToList())
                {
                    Con.Open();
                    ...
                    // Con.Dispose();
                     ...
                     cemp = dbcontext.Cemps.Where(z => z.Cempid == cemp0.Cempid && z.status != "1").FirstOrDefault();
                    if (cemp != null)
                    {
